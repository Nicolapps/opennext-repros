// The comparison itself: send the same requests to the three servers, without following redirects.
...
export const PATHS = ["/has", "/has?preview=1", "/missing", "/missing?preview=1"];
