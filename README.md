...
| ----- | ------------------------ | ---------- |
| [`has-query-condition`](./has-query-condition) | `has` / `missing` conditions of type `query` (without `value`) match when the query key is absent. | [pinned](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/f3813d313273/has-query-condition) · [main](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/main/has-query-condition) |
| [`trailing-slash-api`](./trailing-slash-api) | `trailingSlash: true` is not applied to `/api/*` routes. | [pinned](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/f3813d313273/trailing-slash-api) · [main](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/main/trailing-slash-api) |
| [`external-rewrite-port`](./external-rewrite-port) | An external rewrite with params to a `host:port` destination answers 500. | [pinned](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/f3813d313273/external-rewrite-port) · [main](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/main/external-rewrite-port) |
| [`next-data-query-leak`](./next-data-query-leak) | Pages Router: `__nextDataReq` leaks into `context.query` for `/_next/data/…` requests. | [pinned](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/f3813d313273/next-data-query-leak) · [main](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/main/next-data-query-leak) |
| [`isr-double-revalidation`](./isr-double-revalidation) | A stale ISR page (Pages Router) is regenerated twice. | [pinned](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/f3813d313273/isr-double-revalidation) · [main](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/main/isr-double-revalidation) |
| [`revalidate-tag-stale-fetch`](./revalidate-tag-stale-fetch) | A cached `fetch` without `next.revalidate` is never refreshed after `revalidateTag(tag, "max")`. | [pinned](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/f3813d313273/revalidate-tag-stale-fetch) · [main](https://stackblitz.com/github/Nicolapps/opennext-repros/tree/main/revalidate-tag-stale-fetch) |
